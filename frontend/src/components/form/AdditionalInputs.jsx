...
export const AdditionalInputs = () => {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-gray-400 bg-gray-50/50 rounded-xl border-2 border-dashed border-gray-200 animate-fade-in-down h-[400px]">
